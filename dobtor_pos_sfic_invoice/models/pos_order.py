...
class PosOrder(models.Model):
    ...
    purchase_journal = fields.Many2one('account.journal', related='session_id.config_id.purchase_journal_id',
                                   string='Purchase Journal', store=True, readonly=True)
    ...
    def _prepare_bank_statement_line_payment_values(self, data):
        ...
        if self.returned_order:
            args['account_id'] = (self.partner_id.property_account_payable_id.id) or False
        else:
