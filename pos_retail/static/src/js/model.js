...
odoo.define('pos_retail.model', function (require) {
    ...
    models.PosModel = models.PosModel.extend({
        ...
        push_order: function (order, opts) {
            var self = this;
            if (order) {
                this.save_receipt_and_ticket_to_order();
            }
    ...
    models.load_models([
        ...
        },
        {
            ...
            domain: function (self) {
                return [
                    ['life_date', '>=', time.date_to_str(new Date()) + " " + time.time_to_str(new Date())],
                ]
            },
