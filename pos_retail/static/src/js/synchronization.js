odoo.define('pos_retail.synchronization', function (require) {
    ...
    models.PosModel = models.PosModel.extend({
        ...
        load_orders: function () {
            ...
            this.chrome.loading_message(_t('Waiting restore all transactions'), 1);
            ...
            this.chrome.loading_message(_t('Restored all transactions'), 1);
        },
        ...
        syncing_sessions: function (message) {
            ...
            console.log('{syncing coming}' + action);
        ...
        load_server_data: function () {
            ...
            return _super_PosModel.load_server_data.apply(this, arguments).then(function () {
                if (self.config.bus_id) {
                    ...
                    return bus_log.then(function (messages) { // restore transactions
    ...
    models.Order = models.Order.extend({
        ...
        set_client: function (client) {
            ...
            if (client && client['property_product_pricelist'] && this.pricelist && this.pricelist['id'] != client['property_product_pricelist'][0]) {
