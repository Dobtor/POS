    ...
    models.PosModel = models.PosModel.extend({
        ...
        initialize: function (session, attributes) {
            ...
            if (this.server_version == 10) {
                ...
                this.models.push(
                    {
                        ...
                        loaded: function (self, pricelist_items) {
                            pricelist_items = pricelist_items.sort(self.sort_by('id', true, parseInt));
                ...
                //     // stop sort, because have some issue when multi pricelist items applied
                //     pricelist_items = pricelist_items.sort(self.sort_by('id', true, parseInt));
                //     // *************************************
        ...
        load_server_data: function () {
            ...
            return _super_PosModel.load_server_data.apply(this, arguments).then(function () {
                ...
                setTimeout(function () {
                    console.log('Last updated date pos indexDB: ' + self.write_date);
                    if (self.write_date) {
                        return rpc.query({
                            model: 'pos.cache.database',
                            ...
                            if (results.length) {
                                ...
                                if (self.config.auto_sync) {
                                    ...
                                    return self.gui.show_popup('confirm', {
                                        title: 'It high priority',
                                        body: 'It is important, have many products, customers information changed, are you need update the same ?',
                                        confirm: function () {
                                            for (var i = 0; i < results.length; i++) {
                                                var result = results[i];
                                                if (self.server_version != 12) {
