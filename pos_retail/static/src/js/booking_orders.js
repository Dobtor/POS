    ...
    var popup_create_sale_order = PopupWidget.extend({ // popup create sale order
        ...
        renderElement: function () {
            ...
            this.$('.confirm').click(function () {
                ...
                self.pos.save_receipt_and_ticket_to_order();
                if (!order) {
                    return;
                }
                ...
                var value = {
                    ...
                    receipt_xml: so_val.receipt_xml,
                    receipt_html: so_val.receipt_html,
                };
                ...
                return rpc.query({
                    ...
                    return self.gui.show_popup('confirm', {
                        title: 'Done',
                        body: result['name'] + ' created. Are you want review order now ?',
                        confirm: function () {
                    ...
                    if (self.pos.config.sale_order_print_receipt) {
                        ...
                        return order.destroy({'reason': 'abandon'});
                    }
